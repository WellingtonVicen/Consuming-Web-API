...
const headerProps = {
   icon: 'Users',
   title: 'Editar item',
   subtitle: 'Edite o Item em sua lista '
}
...
export default function EditItem() {
    ...
    const handleFormSubmit = e => {
            ...
            axios.put("http://192.168.0.2/api/v1/itens/update", formData, {
                headers: {
    ...
    return(
        <Container>
            ...
            <form onSubmit={handleFormSubmit} encType="multipart/form-data">
                ...
                <hr />
                <div class="form-row">      
                <Button appearance="primary" type="submit">Edit Item</Button>
                </div>  
            </form> 
